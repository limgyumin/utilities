...
type Condition = {
  <P, S extends P, R1>(condition: Guard<P, S>, truthy: Func<[S], R1> | R1): Unary<P, R1>;
  <P, S extends P, R1, R2>(condition: Guard<P, S>, truthy: Func<[S], R1> | R1, falsy: Func<[P], R2>): Unary<P, R1 | R2>;
